...
SUBROUTINE wbse_localization(current_spin,nbnd_s,nbnd_e,evc_loc,ovl_matrix,l_restart)
   !----------------------------------------------------------------------------
   !
   USE thrust_kernels,       ONLY : complex_saxpy
   USE kinds,                ONLY : DP
   ...
   !$acc declare device_resident(a_matrix)
